...
class PointsSummaryScreen extends StatelessWidget {
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                // Graphique des tendances (optionnel)
          ...
          ? Row(
              children: [
                ...
                Expanded(
                  child: _buildPointCard(
                    title: 'Total gagné',
                    points: controller.totalEarnedPoints.value,
                    color: Colors.green,
  ...
  Widget _buildTransactionItem(Map<String, dynamic> transaction, PointsSummaryScreenController controller) {
    ...
    final color = controller.getTransactionColor(type);
        ...
        children: [
          Row(
            children: [
              ...
              const Spacer(),
              Text(
                '${controller.vouchers.length} bon(s)',
                style: TextStyle(
                  fontSize: 14,
                  color: Colors.grey[600],
                ),
