                  ...
                  child: Form(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // Section Paramètres de vente (seulement pour non-sponsors)
                        Obx(() {
                          final userType = ec.currentUserType.value;
                          // Ne pas afficher pour les sponsors et associations
                          if (userType != null &&
                              (userType.name == 'Sponsor' || userType.name == 'Association')) {
