...
class ProSellsScreen extends StatelessWidget {
            ...
            child: Center(
              child: ConstrainedBox(
                constraints: BoxConstraints(
                  maxWidth:
                      isTablet ? 800 : UniquesControllers().data.baseMaxWidth,
                ),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    // Section Statistiques
                    _buildStatisticsSection(cc),
                    const CustomSpace(heightMultiplier: 3),

                    // Section Filtres et Tri
                    _buildFiltersSection(cc, list),
                    const CustomSpace(heightMultiplier: 3),
  ...
  Widget _buildStatisticsSection(ProSellsScreenController cc) {
  ...
  Widget _buildFiltersSection(ProSellsScreenController cc, List list) {
    return CustomCardAnimation(
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              _buildFilterChip(
                                label: 'Récupérées',
                                isSelected:
                                    cc.filterStatus.value == 'reclaimed',
